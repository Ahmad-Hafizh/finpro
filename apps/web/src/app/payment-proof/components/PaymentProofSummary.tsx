    ...
    <Box sx={{ mb: 4 }}>
        ...
        {orderDetail.free_item && (
          ...
          >
            <CardContent sx={{ p: 2 }}>
              <Grid container spacing={2} alignItems="center">
                <Grid size={{ xs: 3, sm: 2 }}>
                  {orderDetail.free_item.product?.product_img?.length ? (
                    <img
                      src={orderDetail.free_item.product.product_img[0].url}
                      alt={orderDetail.free_item.product.product_name}
                      style={{
                        width: "100%",
                        aspectRatio: "1/1",
                        borderRadius: 8,
                ...
                <Grid size={{ xs: 9, sm: 10 }}>
                  <Typography variant="subtitle1" fontWeight={600}>
                    {orderDetail.free_item.product?.product_name} (Free)
                  </Typography>
                  <Box
                    sx={{
                      display: "flex",
                  ...
                  >
                    <Chip
                      size="small"
                      label={`Qty: ${orderDetail.free_item.quantity}`}
      ...
      >
        ...
        <Typography variant="h6" fontWeight="bold">
          Rp {orderDetail.total_payment.toLocaleString()}
        </Typography>
      </Box>
    </Box>
  );
