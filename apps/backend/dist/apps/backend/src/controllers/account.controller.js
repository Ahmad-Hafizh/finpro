    ...
    signUp(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const createUserFlow = yield client_1.prisma.$transaction((tx) => __awaiter(this, void 0, void 0, function* () {
                    var _a, _b;
    ...
    verifyEmailsetPassword(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const newAccount = yield client_1.prisma.user.update({
    ...
    createProfileReferral(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const existProfile = yield client_1.prisma.profile.findUnique({ where: { user_id: id } });
                if (existProfile) {
