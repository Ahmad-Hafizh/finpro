...
const config = {
  generator: {
    ...
    output: {
      value:
        "/Users/macbook/Documents/finpro-jcwd0412/finpro/apps/backend/prisma/generated/client",
      fromEnvVar: null,
    },
    config: {
      engineType: "library",
    ...
    previewFeatures: [],
    sourceFilePath:
      "/Users/macbook/Documents/finpro-jcwd0412/finpro/apps/backend/prisma/schema.prisma",
    isCustomOutput: true,
  },
  relativeEnvPaths: {
    rootEnvPath: null,
  ...
  inlineDatasources: {
    db: {
      url: {
        fromEnvVar: null,
        value:
          "postgresql://postgres.hsleadkzyyhrrhcpspyh:finpro2024@aws-0-ap-southeast-1.pooler.supabase.com:6543/postgres?pgbouncer=true",
      },
    },
  },
  inlineSchema:
  ...
  inlineSchemaHash:
    "cb1b4cfad8897e98759ec48b4ff4ee119d2b908fb55e26ee7b0873c025843ab1",
  copyEngine: true,
};
...
path.join(
  process.cwd(),
  "apps/backend/prisma/generated/client/libquery_engine-darwin-arm64.dylib.node"
);
// file annotations for bundling tools to include these files
