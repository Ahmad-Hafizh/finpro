...
var require_library = __commonJS({
  "generated/client/runtime/library.js"(exports, module) {
    ...
    var _ = (e, t, r) => (
      ...
      vo(
        t || !e || !e.__esModule
          ? Fr(r, "default", { value: e, enumerable: true })
          : r,
        e
      )
    );
    ...
    var Wo = Z((vf, ni) => {
      ...
      P.beep = mt;
      P.link = (e, t) =>
        [Ht, "8", Jr, Jr, t, mt, e, Ht, "8", Jr, Jr, mt].join("");
      P.image = (e, t = {}) => {
    ...
    var zo = Z((Rf, Yo) => {
      ...
      function si(e, t) {
        ...
        if ("TEAMCITY_VERSION" in J)
          return /^(9\.(0*[1-9]\d*)\.|\d{2,}\.)/.test(J.TEAMCITY_VERSION)
            ? 1
            : 0;
      ...
      Yo.exports = {
        supportsColor: Xu,
        stdout: oi(si(true, Ko.isatty(1))),
        stderr: oi(si(true, Ko.isatty(2))),
      };
    });
    var es = Z((Cf, Xo) => {
      "use strict";
    ...
    var rs = Z((Sf, Kt) => {
      ...
      Kt.exports.stderr = (e, t, r = {}) =>
        ts(e, t, { target: "stderr", ...r });
...
`
    ...
    globalThis.DEBUG_COLORS ??= Wn.DEBUG_COLORS
      ? Wn.DEBUG_COLORS === "true"
      : true;
    var Jt = {
      enable(e) {
...
`);
    ...
    var Ue = (e) =>
      Object.assign(me(e), {
        ...
        minLength: (t) =>
          Ue(j(e, ((r) => I((n) => je(n) && n.length >= r))(t))),
    ...
    var ei = class e {
      ...
      when(t, r) {
        ...
        return new e(
          this.input,
          n ? { matched: true, value: r(this.input, this.input) } : Xn
        );
      }
      otherwise(t) {
...
${JSON.stringify(a, null, 2)}`),
    ...
    async function Ju(e) {
      ...
      if (
        (n || (n = await qo(["/lib64", "/usr/lib64", "/lib", "/usr/lib"])), n)
      ) {
        ne(
          `Found libssl.so file using "ldconfig" or other generic paths: ${n}`
        );
        let o = $o(n);
        if ((ne(`The parsed libssl version is: ${o}`), o))
      ...
      return (
        ne("Couldn't find any version of libssl or OpenSSL in the system"), {}
      );
    }
    async function qo(e) {
      for (let t of e) {
...
${c}`);
    ...
    function Gr(e) {
      return Yu(async () => {
        let t = await Vu(e);
        return (
          ne(`Command "${e}" successfully returned "${t.stdout}"`), t.stdout
        );
      });
    }
    async function zu() {
              ...
              : _a2.reduce(function (o, s) {
                  ...
                  if (l === "\\") (c = a[0]), (u = c.replace("\\$", "$"));
                    ...
                    (c = a[0].substring(l.length)),
                      (u = Object.hasOwnProperty.call(t, p)
                        ? t[p]
                        : e.parsed[p] || ""),
                      (u = r(u));
                  }
...
`),
              parsed: {
                ...((_a2 = n == null ? void 0 : n.dotenvResult) == null
                  ? void 0
                  : _a2.parsed),
                ...((_b = i == null ? void 0 : i.dotenvResult) == null
                  ? void 0
                  : _b.parsed),
              },
            }
      ...
      return (
        ...
        ((e == null ? void 0 : e.config.engineType) === "library"
          ...
          : (e == null ? void 0 : e.config.engineType) === "binary"
            ? "binary"
            : (e == null ? void 0 : e.config.engineType) === "client"
              ? "client"
              : fs)
      );
    }
...
${(0, xs.default)(Rc(n), 2)}
    ...
    function Rc(e) {
      ...
      return Object.entries(e).map(([r, n]) => `${r.padEnd(t)} = ${Cc(n)}`)
        .join(`
`);
    }
    function Cc(e) {
    ...
    var ee = class extends Error {
      constructor(
        t,
        { code: r, clientVersion: n, meta: i, batchRequestIdx: o }
      ) {
        super(t),
    ...
    m.inverseTangent = m.atan = function () {
      ...
      return (
        r && (s = s.times(2 << (r - 1))),
        (b = true),
        y(s, (c.precision = p), (c.rounding = d), true)
      );
    };
    m.isFinite = function () {
      return !!this.d;
    ...
    m.minus = m.sub = function (e) {
      ...
      if (
        ((r = re(e.e / E)), (c = re(f.e / E)), (u = u.slice()), (o = c - r), o)
      ) {
        for (
          p = o < 0,
            p
    ...
    m.plus = m.add = function (e) {
      ...
      if (
        ((o = re(p.e / E)), (n = re(e.e / E)), (u = u.slice()), (i = o - n), i)
      ) {
        for (
          i < 0
            ? ((r = u), (i = -i), (s = c.length))
    ...
    m.toNearest = function (e, t) {
      ...
      if (((r = new n(r)), e == null)) {
        ...
        if (
          ((e = new n(e)), t === void 0 ? (t = n.rounding) : se(t, 0, 8), !r.d)
        )
          return e.s ? r : e;
      ...
      return (
        e.d[0]
          ? ((b = false), (r = M(r, e, 0, t, 1).times(e)), (b = true), y(r))
          : ((e.s = r.s), (r = e)),
        r
      );
    };
    ...
    m.toPower = m.pow = function (e) {
      ...
      if (
        ((t = re(e.e / E)), t >= e.d.length - 1 && (r = u < 0 ? -u : u) <= Lc)
      )
    ...
    function Ms(e, t, r, n) {
      ...
      for (b = false; ; ) {
        if (
          (r % 2 && ((o = o.times(t)), Is(o.d, s) && (i = true)),
          (r = re(r / 2)),
          r === 0)
        ) {
    ...
    function Di(e, t) {
      ...
      for (
        t == null ? ((b = false), (l = g)) : (l = t), a = new d(0.03125);
        e.e > -2;
    ...
    function $c(e, t) {
      ...
      if (t.indexOf("_") > -1) {
        if (((t = t.replace(/(\d)_(?=\d)/g, "$1")), Ls.test(t)))
          return Ni(e, t);
          ...
          for (let v = 0; v < O.length; ++v) {
            ...
            for (let U = n, oe = i; U < t.length; oe += t[U].length, ++U) {
              ...
              if (
                ...
                u != 1 && x.matchGrammar(e, t, r, U, oe, true, h),
                o)
              )
                break;
            }
    ...
    x.languages.markup &&
      x.languages.markup.tag.addInlined("script", "javascript");
...
`);
    ...
    function Np(
      ...
      let l = Math.max(1, a.lineNumber - 3),
        u =
          (_a2 = cn.read(a.fileName)) == null
            ? void 0
            : _a2.slice(l, a.lineNumber),
      ...
      if (u && c) {
        ...
        (s.functionName = `${d.code})`),
          (s.location = a),
          n ||
            (u = u.mapLineAt(a.lineNumber, (g) =>
              g.slice(0, d.openingBraceIndex)
            )),
...
`);
    ...
    var St = class e extends ze {
      ...
      getSelectionParent() {
        var _a2, _b;
        let r =
          (_a2 = this.getField("select")) == null
            ? void 0
            : _a2.value.asObject();
        if (r) return { kind: "select", value: r };
        let n =
          (_b = this.getField("include")) == null
            ? void 0
            : _b.value.asObject();
      ...
      getSubSelectionValue(r) {
        var _a2;
        return (_a2 = this.getSelectionParent()) == null
          ? void 0
          : _a2.value.fields[r].value;
      }
      getPrintWidth() {
    ...
    function Up(e, t) {
      var _a2, _b, _c2;
      let r =
        (_a2 = t.arguments.getDeepSubSelectionValue(e.selectionPath)) == null
          ? void 0
          : _a2.asObject();
      r &&
        ((_b = r.getField(e.firstField)) == null ? void 0 : _b.markAsError(),
        (_c2 = r.getField(e.secondField)) == null ? void 0 : _c2.markAsError()),
        t.addErrorMessage(
          (n) =>
    ...
    function Qp(e, t) {
      ...
      let [r, n] = ir(e.selectionPath),
        i = e.outputType,
        o =
          (_a2 = t.arguments.getDeepSelectionParent(r)) == null
            ? void 0
            : _a2.value;
...
Note that ${s.bold("include")} statements only accept relation fields.`),
    ...
    function Gp(e, t, r) {
      ...
      if (n) {
        let i =
          (_b = n.getField("omit")) == null ? void 0 : _b.value.asObject();
        if (i) {
          Jp(e, t, i);
          return;
        }
    ...
    function Wp(e, t) {
      ...
      let r = e.outputType,
        n =
          (_a2 = t.arguments.getDeepSelectionParent(e.selectionPath)) == null
            ? void 0
            : _a2.value,
    ...
    function Hp(e, t) {
      ...
      if (e.selectionPath.length === 0) t.arguments.addSuggestion(n);
        ...
        let [i, o] = ir(e.selectionPath),
          a =
            (_b =
              (_a2 = t.arguments.getDeepSelectionParent(i)) == null
                ? void 0
                : _a2.value.asObject()) == null
              ? void 0
              : _b.getField(o);
        if (a) {
      ...
      let r = e.argumentPath[0],
        n =
          (_a2 = t.arguments.getDeepSubSelectionValue(e.selectionPath)) == null
            ...
            : _a2.asObject();
      n &&
        ((_b = n.getField(r)) == null ? void 0 : _b.markAsError(),
        ad(n, e.arguments)),
        t.addErrorMessage((i) =>
          ta(
            i,
      ...
      let [r, n] = ir(e.argumentPath),
        i =
          (_a2 = t.arguments.getDeepSubSelectionValue(e.selectionPath)) == null
            ...
            : _a2.asObject();
      if (i) {
        (_b = i.getDeepField(e.argumentPath)) == null
          ? void 0
          : _b.markAsError();
        let o =
          (_c2 = i.getDeepFieldValue(r)) == null ? void 0 : _c2.asObject();
        o && oa(o, e.inputType);
      }
      t.addErrorMessage((o) =>
        ta(
    ...
    function Xp(e, t) {
      ...
      let r;
      t.addErrorMessage((l) =>
        (r == null ? void 0 : r.value) instanceof W && r.value.text === "null"
      ...
      let r = e.argument.name,
        n =
          (_a2 = t.arguments.getDeepSubSelectionValue(e.selectionPath)) == null
            ...
            : _a2.asObject();
      n &&
        ((_b = n.getDeepFieldValue(e.argumentPath)) == null
          ? void 0
          : _b.markAsError()),
        t.addErrorMessage((i) => {
          let o = hn(
    ...
    function rd(e, t) {
      ...
      if (n) {
        let s =
          (_b = n.getDeepField(e.argumentPath)) == null ? void 0 : _b.value;
    ...
    function ia(e, t) {
      ...
      let [r, n] = ir(e),
        i =
          (_a2 = t.arguments.getDeepSubSelectionValue(r)) == null
            ? void 0
            : _a2.asObject();
      if (!i) return { parentKind: "unknown", fieldName: n };
      let o = (_b = i.getFieldValue("select")) == null ? void 0 : _b.asObject(),
        s =
          (_c2 = i.getFieldValue("include")) == null ? void 0 : _c2.asObject(),
...
`);
      ...
      constructor(t, r) {
          ...
          return this.extension.client
            ? {
                ...((_a2 = this.previous) == null
                  ? void 0
                  : _a2.getAllClientExtensions()),
                ...this.extension.client,
              }
            : (_b = this.previous) == null
              ? void 0
              : _b.getAllClientExtensions();
        });
        this.batchCallbacks = pr(() => {
          ...
          let t2 =
              ((_a2 = this.previous) == null
                ? void 0
                : _a2.getAllBatchQueryCallbacks()) ?? [],
            r2 =
              (_b = this.extension.query) == null
                ? void 0
                : _b.$__internalBatch;
    ...
    function gd(e, t, r) {
      ...
      return (
        e.modelOrType &&
          !e.isRawAction() &&
          ((n.$composites = true), (n.$scalars = true)),
        t && hd(n, t, e),
        yd(n, r, e),
        n
      );
    ...
    function xd(e) {
      return (
        typeof e == "object" && e !== null && typeof e.toJSON == "function"
      );
    }
    function ji(e, t) {
      e === void 0 &&
    ...
    var Vi = class e {
      ...
      findField(t) {
        var _a2;
        return (_a2 = this.modelOrType) == null
          ? void 0
          : _a2.fields.find((r) => r.name === t);
      }
      nestSelection(t) {
      ...
      getGlobalOmit() {
        ...
        return this.params.modelName && this.shouldApplyGlobalOmit()
          ? (((_a2 = this.params.globalOmit) == null
              ? void 0
              : _a2[xt(this.params.modelName)]) ?? {})
          : {};
      }
    ...
    function ot(e) {
      ...
      return {
        ...
        getPropertyDescriptor(r) {
          var _a2;
          return (_a2 = e.getPropertyDescriptor) == null
            ? void 0
            : _a2.call(e, r);
        },
      };
      ...
      let r = Cd(t),
        ...
        i = new Proxy(e, {
          ...
          has(o, s) {
            ...
            let a = r.get(s);
            return a
              ? (((_a2 = a.has) == null ? void 0 : _a2.call(a, s)) ?? true)
              : Reflect.has(o, s);
          },
          ownKeys(o) {
          ...
          set(o, s, a) {
            ...
            return ((_c2 =
              (_b =
                (_a2 = r.get(s)) == null
                  ? void 0
                  : _a2.getPropertyDescriptor) == null
                ? void 0
                : _b.call(_a2, s)) == null
              ? void 0
              : _c2.writable) === false
          ...
          getOwnPropertyDescriptor(o, s) {
            ...
            return l
              ? l.getPropertyDescriptor
                ? {
                    ...Sn,
                    ...(l == null ? void 0 : l.getPropertyDescriptor(s)),
                  }
                : Sn
              : a;
          },
    ...
    function Sa(e, t) {
      return e.filter((r) => {
        var _a2, _b;
        return (
          ((_b = (_a2 = t.get(r)) == null ? void 0 : _a2.has) == null
            ? void 0
            : _b.call(_a2, r)) ?? true
        );
      });
...
`);
    ...
    function Er(e) {
      if (typeof e != "object" || e == null || e instanceof $e || At(e))
        return e;
    ...
    function Ja(e, t, r, n = 0) {
      return e._createPrismaPromise((i) => {
        ...
        return (
          "transaction" in t &&
            i !== void 0 &&
            (((_a2 = t.transaction) == null ? void 0 : _a2.kind) === "batch" &&
    ...
    function tl() {
      ...
      return typeof Netlify == "object"
        ...
        : typeof EdgeRuntime == "string"
          ? "edge-light"
          : ((_a2 = globalThis.navigator) == null ? void 0 : _a2.userAgent) ===
              om
            ? "workerd"
            : globalThis.Deno
              ? "deno"
    ...
    async function pm(engineType, config) {
      ...
      let binaryTarget = await nt(),
        ...
        searchLocations = [
          ...
          ((_b = (_a2 = config.generator) == null ? void 0 : _a2.output) == null
            ? void 0
            : _b.value) ?? dirname,
...
`;
        ...
        (o === void 0
          ...
          : a
            ...
            : (s == null ? void 0 : s.value)
              ? (i = s.value)
              : (s == null ? void 0 : s.fromEnvVar) && (i = r[s.fromEnvVar]),
    ...
    function hl(e) {
      var _a2;
      if (
        !!((_a2 = e.generator) == null
          ? void 0
          : _a2.previewFeatures.some((r) =>
...
${r}`,
    ...
    var _r = class {
      ...
      propagateResponseExtensions(t) {
        ...
        ((_a2 = t == null ? void 0 : t.logs) == null ? void 0 : _a2.length) &&
          ...
          ((_b = t == null ? void 0 : t.traces) == null ? void 0 : _b.length) &&
    ...
    var Dr = class {
      ...
      wrapEngine(t) {
        ...
        return {
          applyPendingMigrations:
            (_a2 = t.applyPendingMigrations) == null ? void 0 : _a2.bind(t),
        ...
        return async (...r) => {
          ...
          try {
            ...
            if (this.tracingHelper.isEnabled()) {
              let i = await ((_a2 = this.engine) == null
                ? void 0
                : _a2.trace(n));
              if (i) {
                let o = JSON.parse(i);
      ...
      async transaction(t, r, n) {
        ...
        if (t === "start") {
          ...
          o = await ((_a2 = this.engine) == null
            ? void 0
            : _a2.startTransaction(a, i));
        } else
          t === "commit"
            ? (o = await ((_b = this.engine) == null
                ? void 0
                : _b.commitTransaction(n.id, i)))
            : t === "rollback" &&
              (o = await ((_c2 = this.engine) == null
                ? void 0
                : _c2.rollbackTransaction(n.id, i)));
      ...
      async getCurrentBinaryTarget() {
        {
          ...
          let t = await this.tracingHelper.runInChildSpan(
            "detect_platform",
            () => nt()
          );
          if (!Rl.includes(t))
...
You may have to run ${Ve("prisma generate")} for your changes to take effect.`,
      ...
      logger(t) {
        ...
        r &&
          ((r.level =
            (r == null ? void 0 : r.level.toLowerCase()) ?? "unknown"),
          vm(r)
            ? this.logEmitter.emit("query", {
                timestamp: /* @__PURE__ */ new Date(),
                query: r.query,
      ...
      async start() {
        ...
        let t = async () => {
          ...
          try {
            ...
            await ((_a2 = this.engine) == null
              ? void 0
              : _a2.connect(JSON.stringify(r))),
      ...
      async stop() {
        ...
        let t = async () => {
          ...
          await ((_a2 = this.engine) == null
            ? void 0
            : _a2.disconnect(JSON.stringify(r))),
            (this.libraryStarted = false),
      ...
      version() {
        ...
        return (
          (this.versionInfo =
            (_a2 = this.library) == null ? void 0 : _a2.version()),
          ((_b = this.versionInfo) == null ? void 0 : _b.version) ?? "unknown"
        );
      }
      debugPanic(t) {
        var _a2;
        ...
        try {
          await this.start(),
            (this.executingQueryPromise =
              (_a2 = this.engine) == null
                ? void 0
                : _a2.query(o, i, n == null ? void 0 : n.id)),
            (this.lastQuery = o);
          ...
          if (
            s.code === "GenericFailure" &&
            ((_b = s.message) == null ? void 0 : _b.startsWith("PANIC:"))
          )
...
${a.backtrace}`,
    ...
    function ho(e, t) {
      ...
      return ml({
        ...
        engineVersion: (_a2 = e.versionInfo) == null ? void 0 : _a2.commit,
...
`);
    ...
    var Eo =
      ...
      (r) => {
        ...
        if (va(r))
          (n = r.sql),
            (i = { values: Vt(r.values), __prismaRawParameters__: true });
    ...
    function bo(e) {
      return function (r, n) {
        let i,
          o = (s = e) => {
            try {
              return s === void 0 || (s == null ? void 0 : s.kind) === "itx"
                ? (i ??= Ml(r(s)))
                : Ml(r(s));
            } catch (a) {
    ...
    var wo = class {
      ...
      getGlobalTracingHelper() {
        var _a2;
        return (
          ((_a2 = globalThis.PRISMA_INSTRUMENTATION) == null
            ? void 0
            : _a2.helper) ?? km
        );
      }
        ...
        (this.logEmitter = r),
          ...
          (this.dataloader = new Vn({
            ...
            singleLoader: async (n) => {
              var _a2;
              let i =
                  ((_a2 = n.transaction) == null ? void 0 : _a2.kind) === "itx"
                    ? Ul(n.transaction)
                    : void 0,
            ...
            batchBy: (n) => {
              var _a2;
              return ((_a2 = n.transaction) == null ? void 0 : _a2.id)
                ? `transaction-${n.transaction.id}`
                : jl(n.protocolQuery);
            },
            batchOrder(n, i) {
              var _a2, _b;
              return ((_a2 = n.transaction) == null ? void 0 : _a2.kind) ===
                "batch" &&
                ((_b = i.transaction) == null ? void 0 : _b.kind) === "batch"
    ...
    function Ql(e) {
      if (e.kind === "Union")
        return { kind: "Union", errors: e.errors.map(Ql) };
...
Expected string or undefined.`);
    ...
    function Bm(e, t) {
      ...
      for (let o of t)
        switch (o.kind) {
          case "UnknownModel":
            (_a2 = r.arguments.getField(o.modelKey)) == null
              ? void 0
              : _a2.markAsError(),
              r.addErrorMessage(() => `Unknown model name: ${o.modelKey}.`);
            break;
          case "UnknownField":
            (_b = r.arguments.getDeepField([o.modelKey, o.fieldName])) == null
              ? void 0
              : _b.markAsError(),
              r.addErrorMessage(
                () =>
            ...
            break;
          case "RelationInOmit":
            (_c2 = r.arguments.getDeepField([o.modelKey, o.fieldName])) == null
              ? void 0
              : _c2.markAsError(),
              r.addErrorMessage(
                () =>
          ...
          case "InvalidFieldValue":
            (_d2 = r.arguments.getDeepFieldValue([o.modelKey, o.fieldName])) ==
            null
              ? void 0
              : _d2.markAsError(),
              r.addErrorMessage(
    ...
    function ou(e) {
      class t {
        constructor(n) {
          ...
          (e =
            ((_b =
              (_a2 = n == null ? void 0 : n.__internal) == null
                ? void 0
                : _a2.configOverride) == null
              ? void 0
              : _b.call(_a2, e)) ?? e),
            Xa(e),
            n && Zl(n, e);
          ...
          let a =
            (!s && Yt(o, { conflictCheck: "none" })) ||
            ((_c2 = e.injectableEdgeEnv) == null ? void 0 : _c2.call(e));
          try {
            let l = n ?? {},
              u = l.__internal ?? {},
              c = u.debug === true;
            ...
            if (
              ...
              (this._engineConfig = {
                ...
                transactionOptions: {
                  maxWait:
                    ((_d2 = l.transactionOptions) == null
                      ? void 0
                      : _d2.maxWait) ?? 2e3,
                  timeout:
                    ((_e2 = l.transactionOptions) == null
                      ? void 0
                      : _e2.timeout) ?? 5e3,
                  isolationLevel:
                    (_f = l.transactionOptions) == null
                      ? void 0
                      : _f.isolationLevel,
                },
                logEmitter: i,
        ...
        _transactionWithArray({ promises: n, options: i }) {
          let o = Gm.nextId(),
            ...
            a = n.map((l, u) => {
              var _a2;
              if (
                (l == null ? void 0 : l[Symbol.toStringTag]) !== "PrismaPromise"
              )
                throw new Error(
                  "All elements of the array need to be Prisma Client promises. Hint: Please make sure you are not awaiting the Prisma client calls you intended to pass in the $transaction function."
                );
              let c =
                  (i == null ? void 0 : i.isolationLevel) ??
        ...
        async _transactionWithCallback({ callback: n, options: i }) {
          let o = { traceparent: this._tracingHelper.getTraceParent() },
            s = {
              maxWait:
                (i == null ? void 0 : i.maxWait) ??
                this._engineConfig.transactionOptions.maxWait,
              timeout:
                (i == null ? void 0 : i.timeout) ??
        ...
        $transaction(n, i) {
          ...
          let o;
          typeof n == "function"
            ? ((_a2 = this._engineConfig.adapter) == null
                ? void 0
                : _a2.adapterName) === "@prisma/adapter-d1"
              ? (o = () => {
                  throw new Error(
            ...
            l = async (u) => {
              ...
              if (c)
                return this._tracingHelper.runInChildSpan(s.middleware, (O) =>
                  c(u, (v) => (O == null ? void 0 : O.end(), l(v)))
                );
              let { runInTransaction: p, args: d, ...f } = u,
                g = { ...n, ...f };
              d && (g.args = i.middlewareArgsToRequestArgs(d)),
                n.transaction !== void 0 && p === false && delete g.transaction;
...
`
        ...
        _hasPreviewFlag(n) {
          var _a2;
          return !!((_a2 = this._engineConfig.previewFeatures) == null
            ? void 0
            : _a2.includes(n));
        }
        $applyPendingMigrations() {
  ...
  "generated/client/index.js"(exports2) {
    ...
    var config2 = {
      generator: {
        ...
        output: {
          value:
            "/Users/macbook/Documents/finpro-jcwd0412/finpro/packages/database/generated/client",
          fromEnvVar: null,
        },
        config: {
          engineType: "library",
        ...
        previewFeatures: [],
        sourceFilePath:
          "/Users/macbook/Documents/finpro-jcwd0412/finpro/packages/database/prisma/schema.prisma",
        isCustomOutput: true,
      },
      relativeEnvPaths: {
        rootEnvPath: null,
      ...
      inlineSchemaHash:
        "d7168975f04168167e54375c241fa149928d23fd06f9b0f23d8283bc52777610",
      copyEngine: true,
    };
    var fs2 = require("fs");
